...
{
    public static function addContrato($fecha_inicio, $fecha_fin, $id_chofer, $regimen_pago, $monto, $id_vehiculo )
    {
        try{
    ...
    public static function addCalendarioPago($id_contrato)
    {
